"""
Django settings for noisy_disk_dev_61592 project.
...
ROOT_URLCONF = 'noisy_disk_dev_61592.urls'
...
WSGI_APPLICATION = 'noisy_disk_dev_61592.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_disk_dev_61592 API",
    "DESCRIPTION": "API documentation for noisy_disk_dev_61592 App",
    "VERSION": "v1",
}
