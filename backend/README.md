...
## Project Structure
    ...
    ├── noisy_disk_dev_61592  # Django project configurations
...
1. Clone this repo and `cd noisy_disk_dev_61592`
...
2. Clone this repo and `cd noisy_disk_dev_61592`
